...
import {logoutClientUser,getClientBalance} from "../../../pages/redux/Action"
...
class ClientNavbar extends Component {
  ...
  async componentDidMount(){
    ...
    await this.props.getClientBalance(this.props.AuthUser.id)
            ...
            <li className="nav-item  nav-profile border-0">
              <Dropdown alignRight>
                <Dropdown.Toggle className="nav-link count-indicator bg-transparent">
                  <span className="profile-text"> {this.props.AuthUser.username}</span>
                  <img className="img-xs rounded-circle" src={this.props.AuthUser.avatar} alt="Profile" />
                </Dropdown.Toggle>
...
const mapDispatchToProps={
  ...
  logoutClientUser,getClientBalance
